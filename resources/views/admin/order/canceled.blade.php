...
@section('canceled','active')
@section('content')
<nav class="breadcrumb sl-breadcrumb">
  <a class="breadcrumb-item" href="{{route('admin.dashboard')}}">{{__('Dashboard')}}</a>
  <span class="breadcrumb-item active">Canceled Orders</span>
</nav>
        ...
        <div class="col-md-12">
            <div class="card pd-10 pd-sm-20">
                ...
                <table class="table responsive" id="order-table">
                    <thead>
                        <tr>
                            <th class="wd-20p">Canceled Date</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="wd-20p">{{Carbon\Carbon::parse($order->canceled_date)->format('d-M-Y')}}</td>
